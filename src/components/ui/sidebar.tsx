...
const sidebarMenuButtonVariants = cva(
  [
    ...
    // Use primary for hover and active
    "hover:bg-primary hover:text-primary-foreground active:bg-primary active:text-primary-foreground data-[active=true]:bg-primary data-[active=true]:text-primary-foreground data-[active=true]:font-medium data-[state=open]:hover:bg-primary data-[state=open]:hover:text-primary-foreground",
  ].join(" "),
  {
    variants: {
      variant: {
