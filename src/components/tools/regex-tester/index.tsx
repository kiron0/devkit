...
import { ExportDialog } from "@/components/tools/regex-tester/export-dialog"
import { FlagsSelector } from "@/components/tools/regex-tester/flags-selector"
import { MatchDisplay } from "@/components/tools/regex-tester/match-display"
import { MatchStats } from "@/components/tools/regex-tester/match-stats"
import { PatternInput } from "@/components/tools/regex-tester/pattern-input"
import { QuickExamples } from "@/components/tools/regex-tester/quick-examples"
import { TestStringInput } from "@/components/tools/regex-tester/test-string-input"
...
export function RegexTesterAdvanced() {
  ...
  return (
    <ToolLayout
      title="Regex Tester"
      description="Test regular expressions with live results and analysis"
    >
